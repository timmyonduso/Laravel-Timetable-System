                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <p class="mb-4">Step into the Mksu timetable management system, and start efficiently managing your schedule.</p>
                            <a href="" class="btn btn-sm btn-outline-primary">View Timetable</a>
                        </div>
                    </div>
